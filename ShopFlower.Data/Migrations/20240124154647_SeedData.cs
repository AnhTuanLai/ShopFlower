    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeDescription", "This is description of ShopFlower" },
                    { "HomeKeyword", "This is keyword of ShopFlower" },
                    { "HomeTitle", "This is home page of ShopFlower" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 24, 22, 46, 47, 751, DateTimeKind.Local).AddTicks(1505), null, 100000m, 200000m },
                    { 2, new DateTime(2024, 1, 24, 22, 46, 47, 751, DateTimeKind.Local).AddTicks(1512), null, 100000m, 200000m }
                });
